...
<div id="site-header-menu" class="site-header-menu">
	<div id="primary-menu-wrapper" class="menu-wrapper">
		...
		<?php
		if ( get_theme_mod( 'creativity__header_cart_enable', 0 ) && function_exists( 'creativity__cart_link' ) ) {
		...
		<?php
		if ( get_theme_mod( 'creativity__header_cart_enable', 0 ) && function_exists( 'creativity__myaccount_icon_link' ) ) {
