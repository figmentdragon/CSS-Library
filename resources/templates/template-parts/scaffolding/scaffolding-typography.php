...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading"><?php esc_html_e( 'Typography', 'creativity_architect' ); ?></h2>

	<?php
	// H1.
	creativitydisplay_scaffolding_section(
		[
			'title'       => 'H1',
	...
	creativitydisplay_scaffolding_section(
		[
			...
			'usage'       => '<del>creativity architect</del>',
			'output'      => '<p>We use <del>creativity architect</del> wd_s to build themes.</p>',
		]
	);
